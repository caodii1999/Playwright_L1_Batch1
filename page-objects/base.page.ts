...
export abstract class BasePage{
    ...
    getDepartmentMenu(value: string): Locator{
        return this.page.locator(`//div[@class = 'secondary-menu-wrapper']//div[ul[@id = 'menu-all-departments-1']]//li[a[contains(text(), '${value}')]]`);
    }

    getNavItem(value: string): Locator{
        return this.page.locator(`//ul[@id = 'menu-main-menu-1']//li[a[text() = '${value}']]`);
    }

    constructor(protected page: Page){
        this.loginSignUpBtn = page.getByRole('link', { name: 'Log in / Sign up' });
        this.cartBtn = page.locator("//div[contains(@class,'et_element')]/div[contains(@class,'et_b_header-cart')]/a");
