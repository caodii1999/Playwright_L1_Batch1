...
export class CheckoutPage extends BasePage {
    ...
    getPaymentMethod(value: string): Locator{
        return this.page.locator(`//div[@id='order_review']//div//ul//li//label[contains(text(), "${value}")]`);
    }
    ...
    constructor(page: Page){
        super(page);
        this.productNameAndQuantity = page.locator("//div[@id='order_review']//table//tbody//tr//td[@class='product-name']");
        ...
        this.countryDropdown = page.locator("//span[@id='select2-billing_country-container']");
        this.placeOrderBtn = page.locator("//button[@id='place_order']");
        this.countrySearch = page.locator("//input[@class='select2-search__field']");
    }
    ...
    async fillBillingInfo(billing: Billing): Promise<void>{
        ...
        await this.getBillingInput(BillingInputs.FIRST_NAME).fill(billing.firstName);
